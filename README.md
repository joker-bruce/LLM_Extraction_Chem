...
### setup
You can follow [this](https://github.com/meta-llama/llama-recipes/tree/main) to setup the proper environment for the llama-2 or you can try clone this repo and do
```
